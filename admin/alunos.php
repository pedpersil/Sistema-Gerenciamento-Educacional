...
<html dir="ltr" lang="en">
  <head>
    ...
    <title>Sistema de Gerenciamento Educacional - Discentes</title>
    <!-- Favicon icon -->
    <link
      rel="icon"
      type="image/png"
    ...
    >
      ...
      <div class="page-wrapper">
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Admin Dashboard / Discentes</h4>
            </div>
          </div>
        </div>
        <!-- ============================================================== -->
        ...
        <!-- ============================================================== -->
          ...
          <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Lista de discentes</h5>
                  <a class='btn btn-success btn-sm text-white' <?php echo "href='" . BASE_URL . "admin/adicionar_aluno.php'"; ?>>Adicionar discente</a>
...
$aluno = new Aluno();
$alunos = $aluno->getAllStudents();

// Exibe a lista contendo os cursos cadastrados.
foreach ($alunos as $a) {
  echo "<tr><td>{$a['id']}</td> 
        <td>{$a['name']} <br>
        <a class='fas fa-address-card' href='" . BASE_URL . "admin/mostrar_aluno.php?id={$a['id']}'></a>
        <a class='far fa-edit' href='" . BASE_URL . "admin/editar_aluno.php?id={$a['id']}'></a>
        <a class='far fa-trash-alt' href='" . BASE_URL . "admin/excluir_aluno.php?id={$a['id']}' onclick='return confirmDelete(event)'></a>
        </td> 
        <td>{$a['email']}</td> 
        <td>{$a['gender']}</td>
        <td>{$a['identity']}</td>  
        ...
        <td>{$a['father_name']}</td> 
        <td>{$a['mother_name']}</td> 
        <td>{$a['enrollment_number']}</td>
        <td>" . $courseName = $aluno->getCourseNameByStudentId($a['id']) . "</td>
        <td>{$a['status']}</td>  
        <td>
        <a class='fas fa-address-card' href='" . BASE_URL . "admin/mostrar_aluno.php?id={$a['id']}'></a>
        <a class='far fa-edit' href='" . BASE_URL . "admin/editar_aluno.php?id={$a['id']}'></a>
