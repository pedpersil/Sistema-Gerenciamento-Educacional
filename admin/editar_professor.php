...
<html dir="ltr" lang="pt-br">
  <head>
    ...
    <title>Sistema de Gerenciamento Educacional - Editar Docente</title>
    <!-- Favicon icon -->
    <link
      rel="icon"
      type="image/png"
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($password != $confirmPassword) {
        echo "<script>window.location.href = '". BASE_URL ."/admin/editar_professor.php?error=passwordNaoConfere';</script>";
        exit();
    }

    $professor = new Professor();

    if ($professor->updateTeacher($id, $name, $email, $telephone, $password, $cpf, $identity)) {
      ...
      echo "<script>
              Swal.fire({
                  title: 'Erro!',
                  text: 'Não foi possível editar o professor. Tente novamente.',
                  icon: 'error',
...
?>
    ...
    >
      ...
      <div class="page-wrapper">
        ...
        <!-- ============================================================== -->
        <!-- Inicio formulario editar Professor                             -->
        <!-- ============================================================== -->
        <div class="card">
            <form class="form-horizontal" method="post" <?php echo "action='" . BASE_URL . "admin/editar_professor.php'"; ?> onsubmit="return validatePassword()">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="name" name="name" placeholder="Nome completo" value="<?php echo $p['name']; ?>" required />
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="email" class="form-control" id="email" name="email" placeholder="Email" value="<?php echo $p['email']; ?>" required />
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="telephone" name="telephone" placeholder="Telefone" value="<?php echo $p['telephone']; ?>" required />
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="cpf" name="cpf" placeholder="Digite o CPF" maxlength="14" value="<?php echo $p['cpf']; ?>" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="identity" name="identity" placeholder="Identidade" value="<?php echo $p['identity']; ?>" required />
                        </div>
                    </div>
        ...
        <!-- ============================================================== -->
        <!-- End formulario editar professor.                               -->
        <!-- ============================================================== -->
