...
<html dir="ltr" lang="pt-br">
  <head>
    ...
    <title>Sistema de Gerenciamento Educacional - Adicionar Curso</title>
    <!-- Favicon icon -->
    <link
      rel="icon"
      type="image/png"
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($curso->addCourse($name, $description, $code, $status)) {
        ...
        echo "<script>
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '" . BASE_URL . "admin/cursos.php';
                    }
                });
              </script>";
  } else {
      ...
      echo "<script>
              Swal.fire({
                  title: 'Erro!',
                  text: 'Não foi possível adicionar o curso. Tente novamente.',
                  icon: 'error',
                  confirmButtonText: 'OK'
              }).then((result) => {
                  if (result.isConfirmed) {
  ...
  ?>
    ...
    >
      ...
      <div class="page-wrapper">
        ...
        <!-- ============================================================== -->
        <!-- Inicio formulario Adicionar Curso                              -->
        <!-- ============================================================== -->
              
        <div class="card">
    <form class="form-horizontal" method="post" <?php echo "action='" . BASE_URL . "admin/adicionar_curso.php'"; ?>>
        <div class="card-body">
            <h4 class="card-title">Adicionar Curso</h4>

            <!-- Nome do Curso -->
            <div class="form-group row">
                <label for="name" class="col-sm-3 control-label col-form-label">Nome do curso</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="name" name="name" placeholder="Nome do curso" required />
                </div>
            </div>

            <!-- Descrição do Curso -->
            <div class="form-group row">
                <label for="description" class="col-sm-3 control-label col-form-label">Descrição do curso</label>
                <div class="col-sm-9">
            ...
            <!-- Código do Curso -->
            <div class="form-group row">
                <label for="code" class="col-sm-3 control-label col-form-label">Código do curso</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="code" name="code" placeholder="Código do curso" required />
                </div>
            </div>
