...
<html dir="ltr" lang="en">
  <head>
    ...
    <title>Sistema de Gerenciamento Educacional - Disciplinas</title>
    <!-- Favicon icon -->
    <link
      rel="icon"
      type="image/png"
    ...
    >
      ...
      <div class="page-wrapper">
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Admin Dashboard / Disciplinas</h4>
            </div>
          </div>
        </div>
        <!-- ============================================================== -->
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-lg-2 col-xlg-3">
              <div class="card card-hover">
                <div class="box bg-danger text-center">
                <a <?php echo "href='" . BASE_URL . "admin/registrar_usuarios.php'"; ?>>
                  <h1 class="font-light text-white">
                    <i class="mdi mdi-border-outside"></i>
                  </h1>
        ...
        <!-- ============================================================== -->
          ...
          <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Lista de cursos e suas disciplinas</h5>
                  <a class='btn btn-success btn-sm text-white' <?php echo "href='" . BASE_URL . "admin/adicionar_disciplina.php'"; ?>>Adicionar Disciplina</a>
                  <div class="table-responsive">
                    <table
                      id="disciplinas_table"
...
foreach ($disciplinas as $d) {
  echo "<tr><td>{$d['id']}</td> 
        ...
        <td>{$d['status']}</td> 
        <td><a class='far fa-edit' href='" . BASE_URL . "admin/editar_disciplina.php?id={$d['id']}&courseId={$d['course_id']}'></a>
        <a class='far fa-trash-alt' href='" . BASE_URL . "admin/excluir_disciplina.php?id={$d['id']}' onclick='return confirmDelete(event)'></a>
        </td></tr>";
}
?>
                          </tbody>
