...
<html dir="ltr" lang="en">
  <head>
    ...
    <title>Sistema de Gerenciamento Educacional - Cursos</title>
    <!-- Favicon icon -->
    <link
      rel="icon"
      type="image/png"
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Admin Dashboard / Cursos</h4>
            </div>
          </div>
        </div>
        <!-- ============================================================== -->
        ...
        <!-- ============================================================== -->
          <div class="card">
                <div class="card-body">
                  ...
                  <a class='btn btn-success btn-sm text-white' <?php echo "href='" . BASE_URL . "admin/adicionar_curso.php'"; ?>>Adicionar Curso</a>
...
foreach ($cursos as $c) {
  echo "<tr><td>{$c['id']}</td> 
        ...
        <td>{$c['code']}</td>  
        <td>{$c['status']}</td> 
        <td><a class='far fa-edit' href='" . BASE_URL . "admin/editar_curso.php?id={$c['id']}'></a>
        <a class='far fa-trash-alt' href='" . BASE_URL . "admin/excluir_curso.php?id={$c['id']}' onclick='return confirmDelete(event)'></a>
        </td></tr>";
}
?>                
                      </tbody>
