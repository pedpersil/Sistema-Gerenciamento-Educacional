...
<html dir="ltr" lang="pt-br">
  <head>
    ...
    <title>Sistema de Gerenciamento Educacional - Editar Disciplina</title>
    <!-- Favicon icon -->
    <link
      rel="icon"
      type="image/png"
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($disciplina->updateDiscipline($id, $courseId, $name, $code, $teacherId, $status)) {
        // Registro editado com sucesso, redireciona com uma mensagem de sucesso via SweetAlert2
        echo "<script>
                Swal.fire({
                  icon: 'success',
                  title: 'Formulario editado com sucesso!',
      ...
      echo "<script>
              Swal.fire({
                  title: 'Erro!',
                  text: 'Não foi possível editar a disciplina. Tente novamente.',
                  icon: 'error',
...
$disciplina = new Disciplina();
$d = $disciplina->getDisciplineById($id);
?>
    <!-- ============================================================== -->
    ...
    >
      ...
      <div class="page-wrapper">
        ...
        <!-- ============================================================== -->
        <!-- Inicio formulario editar Disciplina                             -->
        <!-- ============================================================== -->
        <div class="card">
    <form class="form-horizontal" method="post" <?php echo "action='" . BASE_URL . "admin/editar_disciplina.php'"; ?>>
        <div class="card-body">
            <h4 class="card-title">Editar Disciplina</h4><br>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="name" name="name" placeholder="Nome da disciplina" value="<?php echo $d['name'] ?>" required/>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="code" name="code" placeholder="Código da disciplina" value="<?php echo $d['code'] ?>" required/>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <select class="form-select shadow-none" name="status" id="status" required>
                        <option value="">Selecione</option>
                        <option value="ativo" <?php echo $d['status'] == "ativo" ? 'selected' : null; ?>>Ativo</option>
                          <option value="inativo" <?php echo $d['status'] == "inativo" ? 'selected' : null; ?>>Inativo</option>
                    </select>
                </div>
            </div>
