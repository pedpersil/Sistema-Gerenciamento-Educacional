...
$adminName = $_SESSION[SESSION_NAME]['name'];
$adminEmail = $_SESSION[SESSION_NAME]['email'];
?>
...
<html dir="ltr" lang="en">
  <head>
    ...
    <title>Sistema de Gerenciamento Educacional - Admin</title>
    <!-- Favicon icon -->
    <link
      rel="icon"
      type="image/png"
      ...
      <div class="page-wrapper">
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Admin Dashboard / Index</h4>
            </div>
          </div>
        </div>
        <!-- ============================================================== -->
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="card p-4">
                    <div class="mb-3">
                      <span class="fw-bold">Logado como: </span><span class="fw-5"><?php echo $adminName; ?></span>
                      <br>
                      <span class="fw-bold">Email:</span> <span class="fw-5"><?php echo $adminEmail; ?></span>
                    </div>
                    <br><br><br><br>
                    <br><br><br><br>
           </div>
