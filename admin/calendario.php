...
<html dir="ltr" lang="en">
  <head>
    ...
    <title>Sistema de Gerenciamento Educacional - Calendário</title>
    <!-- Favicon icon -->
    <link
      rel="icon"
      type="image/png"
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Admin Dashboard / Calendário</h4>
            </div>
          </div>
        </div>
        <!-- ============================================================== -->
          ...
          <div id="calendar"></div>
              ...
              $(document).ready(function() {
                  ...
                  var calendar = new FullCalendar.Calendar(calendarEl, {
                      ...
                      editable: true,
                      selectable: true,
                      events: 'load_events.php', // Carrega os eventos do banco
                      eventDrop: function(info) { // Permite arrastar eventos para mudar a data
                          $.ajax({
                      ...
                      select: function(info) { // Adiciona um novo evento ao clicar
                      ...
                      eventClick: function(info) { // Excluir evento ao clicar
