...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $auth = new Auth();
    if (!$auth->confirmPasswordsMatch($password, $confirmPassword)) {
        $error = "As senhas não coincidem!";
    } else {
        // $auth = new Auth();
        // Chamar o método para registrar um novo administrador
        $result = $auth->registerNewAdmin($name, $email, $password);
        if ($result['status']) {
            $success = $result['message']; // Admin cadastrado com sucesso.
...
<html dir="ltr" lang="en">
  <head>
    ...
    <title>Sistema de Gerenciamento Educacional - Registrar Novo Admin</title>
    <!-- Favicon icon -->
    <link
      rel="icon"
      type="image/png"
  ...
  <body>
    ...
    >
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Admin Dashboard / Registrar Novo Admin</h4>
            </div>
          </div>
        </div>
        <!-- ============================================================== -->
      ...
      <!-- ============================================================== -->
      <!-- Inicio do formulario para adicionar Admin.                     -->
      <!-- ============================================================== -->
      <div class="container-fluid">
          <!-- ============================================================== -->
          <!-- Start Page Content -->
          ...
          <div class="row">
            <div class="card p-4">
                <h2 class="text-center">Registrar Novo Admin</h2>
                <?php if (isset($error)) : ?>
                ...
                <?php endif; ?>
                <form method="POST" <?php echo "action='" . BASE_URL . "admin/registrar_admin.php'"; ?>>
                    <div class="mb-3">
