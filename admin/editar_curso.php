...
<html dir="ltr" lang="en">
  <head>
    ...
    <title>Sistema de Gerenciamento Educacional - Editar Curso</title>
    <!-- Favicon icon -->
    <link
      rel="icon"
      type="image/png"
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($curso->updateCourse($id, $name, $description, $code, $status)) {
      ...
      echo "<script>
              Swal.fire({
                  title: 'Erro!',
                  text: 'Não foi possível editar o curso. Tente novamente.',
                  icon: 'error',
    ...
    >
      ...
      <div class="page-wrapper">
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Admin Dashboard / Editar Curso</h4>
            </div>
          </div>
        </div>
        <!-- ============================================================== -->
        ...
        <!-- ============================================================== -->
              ...
              <div class="card">
                <form class="form-horizontal" method="post" <?php echo "action='" . BASE_URL . "admin/editar_curso.php'"; ?>>
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      >
                      <div class="col-sm-9">
                        <textarea id="description" name="description" class="form-control"><?php echo $c['description']; ?></textarea>
                      </div>
                    </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="col-md-9">
                      ...
                      >
                        <option>Selecione</option>
                          <option value="ativo" <?php echo $c['status'] == "ativo" ? 'selected' : null; ?>>Ativo</option>
                          <option value="inativo" <?php echo $c['status'] == "inativo" ? 'selected' : null; ?>>Inativo</option>
                        </optgroup>
                      </select>
                    </div>
                  </div>
